...
//
//@Config
//@Autonomous(name = "Chamber 1+4 PP", group = "Autos")
//public class Chamber1Plus4PP extends AutoCommandBase {
//
//    public static Pose grab = new Pose(42, -60, 90.00);
//
//    public static double gap = 2;
//
//    public static Pose startPose = new Pose(2.54, -32.08, Math.toRadians(90.00));
//    public static Pose chamber = new Pose(4, -29, 90.00);
//    public static Pose chamber1 = new Pose(chamber.getX() - 2 - gap, chamber.getY(), 90.00);
//    public static Pose chamber2 =
//            new Pose(chamber.getX() - 2 - gap * 2, chamber.getY(), 90.00);
//    public static Pose chamber3 =
//            new Pose(chamber.getX() - 2 - gap * 3, chamber.getY(), 90.00);
//    public static Pose chamber4 =
//            new Pose(chamber.getX() - 2 - gap * 4, chamber.getY(), 90.00);
//
//    public static Vector SampleRect = new Vector(1.5, -3.5);
//    public static Vector SampleValidRect = new Vector(1.875, 2.75);
//    public static Vector Sample1 = MathFunctions.addVectors(new Vector(48, -24), MathFunctions.scalarMultiplyVector(SampleRect, 0.5));
//
//    public static Vector Sample2 = MathFunctions.addVectors(new Vector(48+10, -24), MathFunctions.scalarMultiplyVector(SampleRect, 0.5));
//    public static Vector Sample3 = MathFunctions.addVectors(new Vector(48+20, -24), MathFunctions.scalarMultiplyVector(SampleRect, 0.5));
//
//    public static Pose GrabSample1 = new Pose(23, -38.8, Math.toRadians(26.17));
//    public static Pose GrabSample2 = new Pose(33.95, -39.56, Math.toRadians(29.81));
//    public static Pose GrabSample3 = new Pose(43, -37.81, Math.toRadians(25.89));
//
//
//    public static Pose sample1Observation = new Pose(48.46, -53, 90);
...
//    public static Vector slideExtendOffset = currentRobot == DriveConstants.RobotType.EPSILON ? new Vector(27.625, 0.5) : new Vector(24.45, 0);
//
//    //  public static double startX = 24.43;
//    //  public static double startY = -64.95;
//    public static Pose start = currentRobot == DriveConstants.RobotType.EPSILON ? new Pose(7.67, -64.05, 90) : new Pose(7.67, -64.95, 90.00);
//
...
//
//    public Command pushBlocksCycle(PathChain grab2DropSequence, double admissibleTimeout, PoseArea atGoal){
...
//                drive.trajectorySequenceBuilder(new Pose2d(2.54, -32.08, Math.toRadians(90.00)))
...
//                .lineToLinearHeading(sample1Observation.toPose2d(),
//                        getVelocityConstraint(40, MAX_ANG_VEL, TRACK_WIDTH),
//                        SampleMecanumDrive.getACCEL_CONSTRAINT())
