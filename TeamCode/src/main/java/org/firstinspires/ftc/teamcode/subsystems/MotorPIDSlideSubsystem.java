...
public abstract class MotorPIDSlideSubsystem extends SubsystemBase {
     ...
     * @param percent The desired power output directly to motor.
     *                DON'T NORMALIZE with battery voltage
     */
    ...
    /**
     * Sets the encoder value of motor to 0.
     * It does not guarantee current motor velocity is 0
     */
    abstract void resetEncoder();

    /**
     * Construct a manual reset command, it will start to reset when scheduled,
     * and stop when canceled. It dose not provide verification on whether the slide structure
     * is reset.
    ...
    /**
     * Construct a auto reset command, it will start to reset when scheduled,
     * and stop automatically when it thinks the slide was in place.
     * @return The command constructed.
     */
    public Command autoResetCommand(){
        return new CommandBase() {
            ...
            public void execute () {
                ...
                telemetry.addData("AutoResetCommand.AvgVel", ((getCurrentPosition() - startpos) / t.time()));
            }
            @Override
