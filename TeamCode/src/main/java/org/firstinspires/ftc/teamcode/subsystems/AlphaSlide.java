...
//  public static double slideArmServo_PreGrab = 0.45;
  ...
  public enum Goal {
    ...
    HANDOFF(0.21,           currentRobot==DriveConstants.RobotType.ALPHA?0.13:0.15, currentRobot==DriveConstants.RobotType.ALPHA?0.39:0.645,  0.4,          currentRobot==DriveConstants.RobotType.ALPHA?0.635:0.35);
