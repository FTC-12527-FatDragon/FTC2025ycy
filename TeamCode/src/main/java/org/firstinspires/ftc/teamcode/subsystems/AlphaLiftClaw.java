...
public class AlphaLiftClaw extends SubsystemBase {
  ...
  public enum ServoPositions {
    STOW(currentRobot==DriveConstants.RobotType.ALPHA?0.76:0.83, LiftClaw_Close, currentRobot==DriveConstants.RobotType.ALPHA?0.64:0.615),
    ...
    BASKET(currentRobot==DriveConstants.RobotType.ALPHA?0.34:0.47, LiftClaw_Close, currentRobot==DriveConstants.RobotType.ALPHA?0.35:0.54),
    GRAB(currentRobot==DriveConstants.RobotType.ALPHA?0.155:0.207, LiftClaw_Open, currentRobot==DriveConstants.RobotType.ALPHA?0.08:0.35);
