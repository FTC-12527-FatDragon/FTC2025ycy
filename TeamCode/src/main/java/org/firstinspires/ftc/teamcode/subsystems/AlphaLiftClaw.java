...
public class AlphaLiftClaw extends SubsystemBase {
  ...
  public static double LiftClaw_Open = currentRobot==DriveConstants.RobotType.ALPHA?0.7:0.31;
  public static double LiftClaw_CloseTight = currentRobot==DriveConstants.RobotType.ALPHA?0.4:0.58;
  public static double LiftClaw_CloseLoose = currentRobot==DriveConstants.RobotType.ALPHA?0.4:0.56;
  public static double LiftClaw_Close = LiftClaw_CloseLoose;
  ...
  public enum ServoPositions {
    STOW(currentRobot==DriveConstants.RobotType.ALPHA?0.76:0.82, LiftClaw_Close, currentRobot==DriveConstants.RobotType.ALPHA?0.64:0.64),
    ...
    BASKET(currentRobot==DriveConstants.RobotType.ALPHA?0.37:0.41, LiftClaw_Close, currentRobot==DriveConstants.RobotType.ALPHA?0.35:0.5),
    GRAB(currentRobot==DriveConstants.RobotType.ALPHA?0.15:0.186, LiftClaw_Open, currentRobot==DriveConstants.RobotType.ALPHA?0.08:0.35);
